...
namespace Cascade.WebShop.Helpers
{
    ...
    {
        // See http://edoceo.com/notabene/sql-country-codes
        //private static Dictionary<string, string> allCodes = new Dictionary<string, string> 
        //
        private static SelectListItem[] allCodes = new SelectListItem[]
        {
                ...
                new SelectListItem{ Value="CW", Text="Cura̤ao"},
                ...
                new SelectListItem{ Value="BL", Text="Saint Barth̩lemy"},
        ...
        {
            return allCodes.Any(c => c.Value == code);
        }

        public static string GetCode(string country)
        {
            return allCodes.FirstOrDefault(c=>string.Compare(c.Text, country, true) == 0).Value;
        }

        public static string GetCountry(string code)
        {
            return allCodes.FirstOrDefault(c => string.Compare(c.Value, code, true) == 0).Text;
        }
